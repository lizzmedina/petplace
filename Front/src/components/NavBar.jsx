        ...
        <ThemeProvider theme={theme}>
          <Box sx={{ display: 'flex', alignItems: 'center', textAlign: 'center' }}>
            <Tooltip title="Account settings">
              ...
              >
                <Avatar sx={{ width: 40, height: 40, backgroundColor: '#8ED1B9' }}>
                  {userConnected.name[0].toUpperCase()}{userConnected.lastName[0].toUpperCase()}
                </Avatar>
              </IconButton>
            </Tooltip>
          </Box>
      ...
      {!userConnected && (
        <div className="burgermenu">
          ...
          <nav className="navbar">
            <ul id="menu">
              <li className="item">
                <Link to="/register" className="change-button">Crear Cuenta</Link>
              </li>
              <li className="item">
                <Link to="/login" className="change-button">Iniciar Sesión</Link>
              </li>
            </ul>
          </nav>
        </div>
