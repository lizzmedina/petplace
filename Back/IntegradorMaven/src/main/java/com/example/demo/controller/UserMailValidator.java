...
public class UserMailValidator {
    ...
    @PostMapping("/send")
    public ResponseEntity<?> sendMail(/*String emailUser*/){

        SimpleMailMessage email = new SimpleMailMessage();

        email.setTo("vivianaguzmanburitica@gmail.com");
        ...
        email.setText("Bienvenido!  \uD83D\uDC36\uD83D\uDC31,\n" +
                ...
                "\n" +
                "Haz clic en el siguiente enlace de verificación: [http://localhost:8080/api/v1/user/validator]\n" +
                "\n" +
                "Se abrirá una página de confirmación donde podrás verificar tu dirección de correo electrónico.\n" +
                "\n" +
                "Si no puedes hacer clic en el enlace de verificación, copia y pega la URL completa en la barra de direcciones de tu navegador.[http://127.0.0.1:5173/]\n" +
                "\n" +
